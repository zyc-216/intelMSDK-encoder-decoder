...
#ifndef ADDAVIHEADER_H_
#define ADDAVIHEADER_H_

#include <vector>

/*from raw encoded frames to avi, 
	the outputs are in system memory*/
class addAVIHeader
{
...
public:
	addAVIHeader(unsigned width, unsigned height, unsigned bpp, const char* fourcc, unsigned fps,
